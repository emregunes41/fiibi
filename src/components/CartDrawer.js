                    ...
                    >
                      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          <img src="/iyzico-logo-pack/checkout_iyzico_ile_ode/TR/Tr_White_Horizontal/iyzico_ile_ode_horizontal_white.svg" alt="iyzico ile Öde" style={{ height: 16, marginTop: 8, opacity: 0.8 }} />
                        </div>
                        <div style={{ textAlign: "right", flexShrink: 0 }}>
                ...
                {iframeToken && !submitResult && (
                  <motion.div key="paytr-view" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }}>
                    <div style={{ marginBottom: 16 }}>
                      ...
                      <img src="/iyzico-logo-pack/checkout_iyzico_ile_ode/TR/Tr_White_Horizontal/iyzico_ile_ode_horizontal_white.svg" alt="iyzico ile Öde" style={{ height: 20, marginTop: 12, opacity: 0.8 }} />
                    </div>
