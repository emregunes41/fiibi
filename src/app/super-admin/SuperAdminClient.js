...
export default function SuperAdminClient() {
  ...
  const smStatusConfig = {
    NOT_STARTED: { label: "Başvuru Yok", color: "rgba(0,0,0,0.6)", bg: "rgba(0,0,0,0.03)", border: "rgba(0,0,0,0.06)" },
  ...
  if (loading && !stats) return (
    <div style={{ minHeight: "100vh", background: "#f8f8f8", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ textAlign: "center" }}>
        ...
        <div style={{ color: "rgba(0,0,0,0.55)", fontSize: 13 }}>Platform yükleniyor...</div>
      </div>
    </div>
  );
          ...
          {TABS.map((t) => (
            <button
              ...
              style={{
                ...
                color: tab === t.id ? "#1a1a1a" : "rgba(0,0,0,0.4)",
                  ...
                  {[
                    ...
                    <div key={i} style={cardStyle}>
                      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
                        ...
                        <span style={{ fontSize: 11, color: "rgba(0,0,0,0.55)", textTransform: "uppercase", letterSpacing: "0.05em" }}>{s.label}</span>
                      </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 12 }}>
                  ...
                  <>
                    ...
                    <div style={cardStyle}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                        ...
                        <span style={{ fontSize: 11, fontWeight: 700, color: "rgba(0,0,0,0.55)" }}>tahmini</span>
                      </div>
                ...
                {usage.cloudinary?.error ? (
                  <div style={cardStyle}>
                    ...
                    <div style={{ fontSize: 11, color: "rgba(0,0,0,0.6)" }}>.env → CLOUDINARY_API_KEY + SECRET</div>
                  </div>
                ) : (
                  <>
          ...
          {tab === "accounting" && (
            <>
              ...
              {accountingLoading && !accounting ? (
                <div style={{ textAlign: "center", padding: 60, color: "rgba(0,0,0,0.6)" }}>
                ...
                <>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 12, marginBottom: 28 }}>
                    {[
                      ...
                      { label: "Ödeme Bekleyen Müşteriler", value: `${accounting.summary.totalPendingCollection.toLocaleString("tr-TR")}₺`, sub: "Online tahsilat bekleyen tutar", icon: AlertTriangle, color: "rgba(0,0,0,0.6)", gradient: "rgba(0,0,0,0.02)" },
                    ].map((c, i) => (
                      <div key={i} style={{ background: c.gradient, border: "1px solid rgba(0,0,0,0.06)", padding: "18px 20px" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                          <c.icon size={15} style={{ color: c.color }} />
                          <span style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em", color: "rgba(0,0,0,0.55)" }}>{c.label}</span>
                        </div>
                        <div style={{ fontSize: 26, fontWeight: 800, color: "#1a1a1a", marginBottom: 4 }}>{c.value}</div>
                        <div style={{ fontSize: 11, color: "rgba(0,0,0,0.6)" }}>{c.sub}</div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div style={{ display: "flex", gap: 8, marginBottom: 16, flexWrap: "wrap", alignItems: "center" }}>
                    <Filter size={14} style={{ color: "rgba(0,0,0,0.6)" }} />
                    {[
                      { id: "all", label: "Tümü" },
                  ...
                  <div style={{ border: "1px solid rgba(0,0,0,0.06)", overflow: "hidden" }}>
                    ...
                    {(() => {
                      ...
                      if (filtered.length === 0) return (
                        <div style={{ padding: 32, textAlign: "center", color: "rgba(0,0,0,0.6)", fontSize: 13 }}>Bu filtreye uygun işletme yok</div>
                      );
                        ...
                        return (
                          <div key={t.id} style={{
                            ...
                            <div style={{ minWidth: 0 }}>
                              ...
                              <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 10, color: "rgba(0,0,0,0.6)" }}>
                    ...
                    <div style={{
                      ...
                      <div style={{ fontSize: 12, fontWeight: 800, color: "rgba(0,0,0,0.6)", textTransform: "uppercase", letterSpacing: "0.05em" }}>TOPLAM</div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16, marginBottom: 16 }}>
                {[
                  ...
                  <div key={p.key} style={cardStyle}>
                    <div style={{ fontSize: 11, color: "rgba(0,0,0,0.55)", marginBottom: 10, textTransform: "uppercase", letterSpacing: "0.06em" }}>
                      {p.label}
                    </div>
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <input
          ...
          {tab === "tenants" && (
            <>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
                ...
                <span style={{ fontSize: 12, color: "rgba(0,0,0,0.6)" }}>{tenants.length} kayıt</span>
              </div>
                    ...
                    <div key={t.id} style={{
                      ...
                      <div style={{ display: "flex", flexWrap: "wrap", gap: "12px 20px", alignItems: "center", marginBottom: 12 }}>
                        <div style={{ flex: "1 1 220px", minWidth: 200 }}>
                          ...
                          <div style={{ fontSize: 12, color: "rgba(0,0,0,0.55)", display: "flex", gap: 12, flexWrap: "wrap" }}>
                            <span>{t.slug}.{domain}</span>
                            <span>{t.ownerEmail}</span>
                          </div>
                        </div>
                        <div style={{ display: "flex", gap: 16, fontSize: 12, color: "rgba(0,0,0,0.6)" }}>
                      ...
                      <div style={{
                        ...
                        {/* Komisyon Oranı */}
                        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                          <Percent size={13} style={{ color: "rgba(0,0,0,0.55)" }} />
                          <span style={{ fontSize: 11, color: "rgba(0,0,0,0.55)", whiteSpace: "nowrap" }}>Komisyon:</span>
                          <input
                            type="number"
                          ...
                          />
                          <span style={{ fontSize: 12, color: "rgba(0,0,0,0.6)" }}>%</span>
                        </div>
                      ...
                      <div style={{
                        ...
                        <span title="IBAN" style={{ marginLeft: "auto", fontFamily: "monospace", fontSize: 10, color: "rgba(0,0,0,0.6)" }}>{t.iban ? `TR••${t.iban.slice(-4)}` : "IBAN Yok"}</span>
                      </div>
                    </div>
                  );
                })}
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                ...
                <button onClick={() => setInfoModal(null)} style={{ background: "transparent", border: "none", color: "rgba(0,0,0,0.6)", cursor: "pointer" }}><X size={20} /></button>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              <div>
                <h4 style={{ margin: "0 0 12px", fontSize: 13, fontWeight: 700, color: "rgba(0,0,0,0.6)", borderBottom: "1px solid rgba(0,0,0,0.1)", paddingBottom: 8 }}>GENEL & İLETİŞİM</h4>
                <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                  {[
                    ...
                    <div key={item.field} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 14px", background: "rgba(0,0,0,0.02)", border: "1px solid rgba(0,0,0,0.05)" }}>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize: 9, fontWeight: 700, color: "rgba(0,0,0,0.6)", textTransform: "uppercase", marginBottom: 1 }}>{item.label}</div>
                        <div style={{ fontSize: 13, color: "#1a1a1a", fontWeight: 500, wordBreak: "break-all" }}>{item.value || "—"}</div>
                      </div>
                      <button onClick={() => editField(infoModal.id, item.field, item.label, item.value)} style={{ background: "none", border: "none", color: "rgba(0,0,0,0.6)", cursor: "pointer", padding: 4, fontSize: 14 }} title="Düzenle">✏️</button>
                    </div>
                  ))}
                  {/* Slug — özel gösterim */}
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 14px", background: "rgba(139,92,246,0.04)", border: "1px solid rgba(139,92,246,0.1)" }}>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: 9, fontWeight: 700, color: "rgba(0,0,0,0.6)", textTransform: "uppercase", marginBottom: 1 }}>Site Adresi (Slug)</div>
                      <div style={{ fontSize: 13, color: "#1a1a1a", fontWeight: 500, fontFamily: "monospace" }}>
                        <span style={{ color: "#8b5cf6" }}>{infoModal.slug}</span><span style={{ color: "rgba(0,0,0,0.6)" }}>.{domain}</span>
                      </div>
                    </div>
                    <button onClick={() => editField(infoModal.id, "slug", "Slug", infoModal.slug)} style={{ background: "none", border: "none", color: "rgba(0,0,0,0.6)", cursor: "pointer", padding: 4, fontSize: 14 }} title="Düzenle">✏️</button>
                  </div>
                </div>
              </div>
              ...
              {/* ABONELİK & DURUM */}
              <div>
                <h4 style={{ margin: "0 0 12px", fontSize: 13, fontWeight: 700, color: "rgba(0,0,0,0.6)", borderBottom: "1px solid rgba(0,0,0,0.1)", paddingBottom: 8 }}>ABONELİK & DURUM</h4>
...
const iconBtn = {
  ...
  color: "rgba(0,0,0,0.6)", padding: 8, cursor: "pointer",
  display: "flex", alignItems: "center", justifyContent: "center"
};
const smallBtn = {
  background: "rgba(0,0,0,0.04)", border: "1px solid rgba(0,0,0,0.08)",
  color: "rgba(0,0,0,0.6)", padding: "6px 10px", cursor: "pointer",
