          ...
          <div key={p.id} style={{
            ...
            <div style={{ display: "flex", gap: "12px", marginBottom: "12px" }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: "14px", fontWeight: 700, color: "var(--text)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{p.name}</div>
            ...
            <div style={{ display: "flex", gap: "8px", borderTop: "1px solid rgba(255,255,255,0.05)", paddingTop: "12px" }}>
              <button onClick={() => openEditProduct(p)} style={{ flex: 1, background: "rgba(255,255,255,0.05)", border: "none", color: "var(--text)", padding: "8px", fontSize: "12px", fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "6px" }}>
          ...
          <div style={{
            ...
            <div style={{ padding: "20px" }}>
              <form onSubmit={handleSaveCategory} style={{ display: "flex", gap: "8px", marginBottom: "20px" }}>
                <input required value={catName} onChange={e => setCatName(e.target.value)} placeholder="Yeni Kategori Adı" style={{ flex: 1, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", padding: "10px", color: "var(--text)", outline: "none", boxSizing: "border-box" }} />
                <button type="submit" disabled={loading} style={{ background: "var(--text)", color: "var(--bg)", border: "none", padding: "0 16px", fontWeight: 700, cursor: "pointer" }}>Ekle</button>
              </form>
            ...
            <form onSubmit={handleSubmitProduct} style={{ padding: "20px", overflowY: "auto", display: "flex", flexDirection: "column", gap: "16px" }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                <div style={{ gridColumn: "1 / -1", display: "grid", gridTemplateColumns: "2fr 1fr", gap: "16px" }}>
                  <div>
                    ...
                    <input required value={form.name} onChange={e => setForm({...form, name: e.target.value})} style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", padding: "12px", color: "var(--text)", outline: "none", boxSizing: "border-box" }} />
                  </div>
                  <div>
                    <label style={{ display: "block", fontSize: "12px", fontWeight: 700, color: "rgba(255,255,255,0.5)", marginBottom: "6px" }}>Kategori</label>
                    <select value={form.categoryId} onChange={e => setForm({...form, categoryId: e.target.value})} style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", padding: "12px", color: "var(--text)", outline: "none", boxSizing: "border-box" }}>
                ...
                <div style={{ gridColumn: "1 / -1" }}>
                  ...
                  <input value={form.description} onChange={e => setForm({...form, description: e.target.value})} placeholder="Vitrin listelemesi için (opsiyonel)" style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", padding: "10px", color: "var(--text)", outline: "none", boxSizing: "border-box" }} />
                </div>
                ...
                <div style={{ gridColumn: "1 / -1" }}>
                  ...
                  <textarea value={form.detailedDescription} onChange={e => setForm({...form, detailedDescription: e.target.value})} placeholder="Ürün özelliklerini detaylı anlatın. Alt satıra geçilebilir." style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", padding: "12px", color: "var(--text)", outline: "none", minHeight: "120px", boxSizing: "border-box" }} />
                </div>

                <div>
                  <label style={{ display: "block", fontSize: "12px", fontWeight: 700, color: "rgba(255,255,255,0.5)", marginBottom: "6px" }}>Fiyat (₺) *</label>
                  <input required type="text" value={form.price} onChange={e => setForm({...form, price: e.target.value})} placeholder="Örn: 500" style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", padding: "12px", color: "var(--text)", outline: "none", boxSizing: "border-box" }} />
                </div>

                <div>
                  <label style={{ display: "block", fontSize: "12px", fontWeight: 700, color: "rgba(255,255,255,0.5)", marginBottom: "6px" }}>İndirim (%)</label>
                  <input type="number" min="0" max="100" value={form.discountPercentage} onChange={e => setForm({...form, discountPercentage: e.target.value})} style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", padding: "12px", color: "var(--text)", outline: "none", boxSizing: "border-box" }} />
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", padding: "12px", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.05)" }}>
                <div>
                  <label style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer", fontSize: 13, fontWeight: 600 }}>
                    <input type="checkbox" checked={form.isDigital} onChange={e => setForm({...form, isDigital: e.target.checked})} style={{ width: 16, height: 16, accentColor: "var(--text)" }} />
                    Dijital Ürün mü?
                  </label>
                ...
                {form.isDigital && (
                  <div>
                    ...
                    <input type="url" placeholder="https://" value={form.downloadUrl} onChange={e => setForm({...form, downloadUrl: e.target.value})} style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", padding: "10px", color: "var(--text)", outline: "none", boxSizing: "border-box" }} />
                  </div>
                )}
              </div>
              ...
              {!form.isDigital && (
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", padding: "12px", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.05)" }}>
                  <div>
                    <label style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer", fontSize: 13, fontWeight: 600 }}>
                      <input type="checkbox" checked={form.hasStock} onChange={e => setForm({...form, hasStock: e.target.checked})} style={{ width: 16, height: 16, accentColor: "var(--text)" }} />
                  ...
                  {form.hasStock && (
                    <div>
                      ...
                      <input type="number" required min="0" value={form.stock} onChange={e => setForm({...form, stock: e.target.value})} style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", padding: "10px", color: "var(--text)", outline: "none", boxSizing: "border-box" }} />
                    </div>
                  )}
                </div>
              )}
                ...
                >
                  {({ open }) => (
                    <button type="button" onClick={() => open()} style={{
                      ...
                      padding: "24px", color: "var(--text)", outline: "none", cursor: "pointer", display: "flex", flexDirection: "column",
                    ...
                    {form.imageUrls.map((url, i) => (
                      <div key={i} style={{ position: "relative", width: "100%", paddingTop: "100%", background: "rgba(0,0,0,0.5)", border: "1px solid rgba(255,255,255,0.1)" }}>
                        ...
                        <button type="button" onClick={() => setForm(p => ({ ...p, imageUrls: p.imageUrls.filter((_, idx) => idx !== i) }))} style={{
                          position: "absolute", top: -6, right: -6, background: "#ef4444", color: "var(--text)", border: "none",
              ...
              <div style={{ display: "flex", justifySelf: "flex-end", gap: "12px", marginTop: "16px" }}>
                <button type="button" onClick={() => setIsProductModalOpen(false)} style={{ padding: "12px 24px", background: "rgba(255,255,255,0.05)", color: "var(--text)", border: "none", fontWeight: 600, cursor: "pointer", marginLeft: "auto" }}>İptal</button>
                <button type="submit" disabled={loading} style={{ padding: "12px 24px", background: "var(--text)", color: "var(--bg)", border: "none", fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", gap: "8px" }}>
