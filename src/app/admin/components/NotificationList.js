...
export default function NotificationList({ notifications }) {
  ...
  return (
    <div style={{ background: "rgba(0,0,0,0.05)", border: "1px solid rgba(0,0,0,0.1)", borderRadius: 0, overflow: "hidden", marginBottom: "3rem" }}>
      <div style={{ padding: "1.5rem 2rem", borderBottom: "1px solid rgba(0,0,0,0.1)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
      ...
      <div style={{ padding: "1rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          {unread.map(notif => (
            <div key={notif.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", padding: "1rem 1.5rem", background: "rgba(0,0,0,0.06)", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 0, gap: "1rem" }}>
              <div>
                ...
                <div style={{ fontSize: "0.95rem", fontWeight: 600, color: "#1a1a1a", lineHeight: "1.4" }}>
                  {notif.message}
                </div>
              </div>
              <button 
