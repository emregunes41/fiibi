      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 8 }}>
          <div style={{ width: 48, height: 48, borderRadius: 0, background: "rgba(255,255,255,0.04)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <FileText size={24} style={{ color: "rgba(255,255,255,0.7)" }} />
          </div>
          ...
          <div style={{ color: "rgba(255,255,255,0.8)", fontSize: 15, lineHeight: 1.7, display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            {siteConfig?.contractText ? (
              ...
              <>
                ...
                <section>
                  <h3 style={{ fontSize: 18, fontWeight: 700, color: "#fff", marginBottom: 12, display: "flex", alignItems: "center", gap: 8 }}><span style={{ color: "rgba(255,255,255,0.7)" }}>2.</span> REZERVASYON VE KAPORA</h3>
                ...
                <section>
                  <h3 style={{ fontSize: 18, fontWeight: 700, color: "#fff", marginBottom: 12, display: "flex", alignItems: "center", gap: 8 }}><span style={{ color: "rgba(255,255,255,0.7)" }}>3.</span> ÖDEME KOŞULLARI</h3>
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                <section>
                  <h3 style={{ fontSize: 18, fontWeight: 700, color: "#fff", marginBottom: 12, display: "flex", alignItems: "center", gap: 8 }}><span style={{ color: "rgba(255,255,255,0.7)" }}>4.</span> TARİH DEĞİŞİKLİĞİ VE İPTAL</h3>
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                <section>
                  <h3 style={{ fontSize: 18, fontWeight: 700, color: "#fff", marginBottom: 12, display: "flex", alignItems: "center", gap: 8 }}><span style={{ color: "rgba(255,255,255,0.7)" }}>5.</span> ÇEKİM GÜNLERİ</h3>
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                <section>
                  <h3 style={{ fontSize: 18, fontWeight: 700, color: "#fff", marginBottom: 12, display: "flex", alignItems: "center", gap: 8 }}><span style={{ color: "rgba(255,255,255,0.7)" }}>6.</span> TESLİM SÜRESİ</h3>
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                <section>
                  <h3 style={{ fontSize: 18, fontWeight: 700, color: "#fff", marginBottom: 12, display: "flex", alignItems: "center", gap: 8 }}><span style={{ color: "rgba(255,255,255,0.7)" }}>8.</span> TEKNİK SORUMLULUK</h3>
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            <div style={{ marginTop: 24, padding: 24, background: "rgba(74,222,128,0.05)", borderRadius: 0, border: "1px solid rgba(255,255,255,0.1)", display: "flex", gap: 16 }}>
