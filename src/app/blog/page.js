    ...
    <main style={{ minHeight: "100vh", background: "var(--bg, #0a0a0a)", color: "var(--text, #fff)", padding: "40px 20px" }}>
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 40 }}>
          <Link href="/" style={{ display: "inline-flex", alignItems: "center", gap: 8, color: "rgba(0,0,0,0.6)", textDecoration: "none", fontSize: 14, fontWeight: 600 }}>
        ...
        <p style={{ color: "rgba(0,0,0,0.6)", fontSize: "1.1rem", marginBottom: 48, lineHeight: 1.6 }}>
              ...
              <Link key={post.id} href={`/blog/${post.slug}`} style={{ textDecoration: "none", display: "block" }}>
                <article style={{ 
                  ...
                  <div style={{ padding: "32px 24px" }}>
                    ...
                    <h2 style={{ fontSize: 22, fontWeight: 800, margin: "0 0 12px 0", color: "var(--text, #1a1a1a)", lineHeight: 1.3 }}>
                      {post.title}
                    </h2>
                    {post.excerpt && (
                      <p style={{ fontSize: 15, color: "rgba(0,0,0,0.6)", margin: 0, lineHeight: 1.6, display: "-webkit-box", WebkitLineClamp: 3, WebkitBoxOrient: "vertical", overflow: "hidden" }}>
                        {post.excerpt}
                      </p>
                    )}
