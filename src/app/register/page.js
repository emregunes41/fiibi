        ...
        <div style={{ background: "rgba(0,0,0,0.04)", backdropFilter: "blur(40px)", borderRadius: 0, border: "1px solid rgba(0,0,0,0.08)", padding: "40px 36px", boxShadow: "0 40px 100px rgba(0,0,0,0.5)" }}>
          ...
          <form onSubmit={handleRegister} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <button 
              ...
              style={{ width: "100%", background: "#1a1a1a", color: "#ffffff", fontWeight: 700, padding: "14px", borderRadius: 0, marginTop: 8, display: "flex", alignItems: "center", justifyContent: "center", gap: 10, border: "none", cursor: "pointer", fontSize: 15, transition: "all 0.2s ease", opacity: (isLoading || !formData.kvkkAccepted) ? 0.5 : 1 }}
            >
