...
export default function FailPage() {
  return (
    <div style={{ 
      ...
      {/* Background Glow */}
      <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '400px', height: '400px', background: 'rgba(0,0,0,0.03)', filter: 'blur(100px)', zIndex: 0 }} />

      <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <div style={{ 
          width: '120px', height: '120px', borderRadius: 0, background: 'rgba(0,0,0,0.03)', 
          ...
          <XCircle size={60} color="rgba(0,0,0,0.55)" />
        </div>
