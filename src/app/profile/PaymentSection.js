...
export default function PaymentSection({ reservation }) {
  ...
  if (isPaid) {
    return (
      <div style={{ marginTop: 20, background: "rgba(74,222,128,0.08)", border: "1px solid rgba(74,222,128,0.15)", borderRadius: 14, padding: "16px 20px" }}>
  ...
  return (
    <>
      <div style={{ marginTop: 20, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 14, padding: "20px" }}>
        {/* Summary */}
