    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 32, maxWidth: 680 }}>
      ...
      <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 0, overflow: "hidden", display: "flex", flexDirection: "column", maxWidth: 680 }}>
        ...
        <div style={{ padding: "24px 24px 20px 24px", display: "flex", alignItems: "center", gap: 16, borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          ...
          <div>
            <h2 style={{ fontSize: 16, fontWeight: 700, letterSpacing: "-0.01em", color: "var(--text)", marginBottom: 2 }}>Hesap Bilgileri</h2>
        ...
        <form onSubmit={handleProfileSubmit} className="flex flex-col gap-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <input 
                ...
                required
                style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 0, padding: "14px 16px", color: "var(--text)", fontSize: 14, outline: "none", transition: "all 0.2s" }}
              />
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                <select 
                  ...
                  style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 0, padding: "14px 16px", color: "var(--text)", fontSize: 14, outline: "none", appearance: "none" }}
                >
                  <option value="" style={{ color: "var(--bg)" }}>Seçiniz</option>
                  <option value="KADIN" style={{ color: "var(--bg)" }}>Kadın</option>
                  <option value="ERKEK" style={{ color: "var(--bg)" }}>Erkek</option>
                  <option value="DIGER" style={{ color: "var(--bg)" }}>Diğer</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div style={{ flex: 1 }}>
              {saveSuccess && (
                <span style={{ color: "var(--text)", fontSize: 12, fontWeight: 600, display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <button 
              type="submit" 
              disabled={isSaving}
              style={{ background: "var(--text)", color: "var(--bg)", border: "none", borderRadius: 0, padding: "14px 24px", fontSize: 13, fontWeight: 700, transition: "all 0.2s", cursor: isSaving ? "not-allowed" : "pointer", opacity: isSaving ? 0.7 : 1 }}
      ...
      <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 0, overflow: "hidden", display: "flex", flexDirection: "column", maxWidth: 680 }}>
        ...
        <div style={{ padding: "24px 24px 20px 24px", display: "flex", alignItems: "center", gap: 16, borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          ...
          <div>
            <h2 style={{ fontSize: 16, fontWeight: 700, letterSpacing: "-0.01em", color: "var(--text)", marginBottom: 2 }}>Şifre Değiştir</h2>
        ...
        <form onSubmit={handlePasswordSubmit} className="flex flex-col gap-5">
          ...
          <div className="mt-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <button 
              ...
              style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", color: "var(--text)", borderRadius: 0, padding: "14px 24px", fontSize: 13, fontWeight: 700, transition: "all 0.2s", cursor: isPwdSaving ? "not-allowed" : "pointer", opacity: isPwdSaving ? 0.7 : 1 }}
              className="flex items-center justify-center gap-2 w-full md:w-auto"
            >
